CLASS zcl_abapgit_object_dtix DEFINITION
  ...
  PRIVATE SECTION.
    ...
    DATA:
      mr_entity_index          TYPE REF TO data,
      mv_entity_index_key      TYPE seu_objkey,
...
CLASS zcl_abapgit_object_dtix IMPLEMENTATION.
  ...
  METHOD clear_field.
    ...
    ASSIGN COMPONENT iv_fieldname OF STRUCTURE cs_entity_index
           TO <lv_value>.
    IF sy-subrc = 0.
      CLEAR: <lv_value>.
    ENDIF.
  ...
  METHOD clear_fields.
    ...
    clear_field(
      ...
      CHANGING
        cs_entity_index = cs_entity_index ).
  ...
  METHOD constructor.
    ...
    mv_entity_index_key = ms_item-obj_name.
  ...
  METHOD fill_metadata_from_db.
    ...
    DATA:
      ...
      lr_entity_index_old   TYPE REF TO data.

    FIELD-SYMBOLS:
      <ls_entity_index_old> TYPE any,
    ...
    CREATE DATA lr_entity_index_old TYPE ('CL_BLUE_SOURCE_OBJECT_DATA=>TY_OBJECT_DATA').

    ASSIGN lr_entity_index_old->* TO <ls_entity_index_old>.
    ASSERT sy-subrc = 0.

    CALL METHOD li_wb_object_operator->('IF_WB_OBJECT_OPERATOR~READ')
      IMPORTING
        data = <ls_entity_index_old>.

    ASSIGN COMPONENT 'METADATA-CREATED_BY' OF STRUCTURE cs_entity_index
           TO <lv_created_by>.
    ASSERT sy-subrc = 0.

    ASSIGN COMPONENT 'METADATA-CREATED_AT' OF STRUCTURE cs_entity_index
           TO <lv_created_at>.
    ASSERT sy-subrc = 0.

    ASSIGN COMPONENT 'METADATA-CREATED_BY' OF STRUCTURE <ls_entity_index_old>
           TO <lv_created_by_old>.
    ASSERT sy-subrc = 0.

    ASSIGN COMPONENT 'METADATA-CREATED_AT' OF STRUCTURE <ls_entity_index_old>
  ...
  METHOD get_wb_object_operator.
    ...
    ls_object_type-objtype_tr = 'DTIX'.
    ...
    TRY.
        CALL METHOD ('CL_WB_OBJECT_OPERATOR')=>('CREATE_INSTANCE')
          EXPORTING
            ...
            object_key  = mv_entity_index_key
          RECEIVING
  ...
  METHOD zif_abapgit_object~deserialize.
    ...
    FIELD-SYMBOLS:
      ...
      <ls_entity_index>          TYPE any,
      <lv_source>                TYPE data.

    ASSIGN mr_entity_index->* TO <ls_entity_index>.
    ASSERT sy-subrc = 0.
    ...
    TRY.
        ...
        ASSIGN COMPONENT 'CONTENT-SOURCE' OF STRUCTURE <ls_entity_index>
               TO <lv_source>.
        ASSERT sy-subrc = 0.
        ...
        IF zif_abapgit_object~exists( ) = abap_true.
          ...
          fill_metadata_from_db( CHANGING cs_entity_index = <ls_entity_index> ).
          li_object_data_model->set_data( <ls_entity_index> ).
        ...
        ASSIGN COMPONENT 'METADATA-ABAP_LANGUAGE_VERSION' OF STRUCTURE <ls_entity_index>
          TO <lv_abap_language_version>.
        IF sy-subrc = 0.
          set_abap_language_version( CHANGING cv_abap_language_version = <lv_abap_language_version> ).

          TRY.
              UPDATE ('DDDTIX_SRC') SET abap_language_version = <lv_abap_language_version>
                WHERE index_name = ms_item-obj_name.
  ...
  METHOD zif_abapgit_object~exists.
    ...
    TRY.
        mi_persistence->get(
          p_object_key           = mv_entity_index_key
          p_version              = 'A'
  ...
  METHOD zif_abapgit_object~serialize.
    ...
    TRY.
        ...
        clear_fields( CHANGING cs_entity_index = <ls_entity_index> ).

      CATCH cx_root INTO lx_error.
        zcx_abapgit_exception=>raise_with_text( lx_error ).
    ENDTRY.

    ASSIGN COMPONENT 'METADATA-ABAP_LANGUAGE_VERSION' OF STRUCTURE <ls_entity_index> TO <lv_abap_language_version>.
    IF sy-subrc = 0.
